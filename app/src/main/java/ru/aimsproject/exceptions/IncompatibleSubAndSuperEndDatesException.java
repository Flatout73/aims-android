 ...
 */
public class IncompatibleSubAndSuperEndDatesException extends IncompatibleAimsDatesException {
    /**
     ...
     */
    public IncompatibleSubAndSuperEndDatesException(String detailMessage, Aim aimCause, Aim superAimCause) {
