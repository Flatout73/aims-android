...
public class Comment {
    ...
    /**
     * Аватарка автора комментария к цели (изображение, сохранённое в виде Bitmap).
     */
    ...
    /**
     * Возвращает аватарку автора комментария к цели (изображение, сохранённое в виде Bitmap).
     * @return Аватарка автора комментария к цели (изображение, сохранённое в виде Bitmap).
     */
