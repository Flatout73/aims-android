...
public class User implements Comparable<User> {
    ...
    /**
     * -2 - пользователь в читаемых, -1 - пользователь в подписчиках, 0 - пользователь не в друзьях, 1 - пользователь в друзьях.
     */
    ...
    /**
     * Возвращает -2 - пользователь в читаемых, -1 - пользователь в подписчиках, 0 - пользователь не в друзьях, 1 - пользователь в друзьях.
     * @return -2 - пользователь в читаемых, -1 - пользователь в подписчиках, 0 - пользователь не в друзьях, 1 - пользователь в друзьях.
     */
    ...
    /**
     * Устанавливает -2 - пользователь в читаемых, -1 - пользователь в подписчиках, 0 - пользователь не в друзьях, 1 - пользователь в друзьях.
     * @param inFriends -2 - пользователь в читаемых, -1 - пользователь в подписчиках, 0 - пользователь не в друзьях, 1 - пользователь в друзьях.
     */
